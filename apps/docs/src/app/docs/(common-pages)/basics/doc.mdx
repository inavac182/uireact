...
You can check all the variables that the theme brings in this [default theme](https://github.com/inavac182/uireact/blob/main/packages/foundation/src/default-theme.scss). But basically they follow this pattern:
...
The token value is the level of the coloration: token_10, token_50, token_100, etc...
