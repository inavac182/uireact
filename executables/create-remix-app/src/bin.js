...
console.log(`Clonning a Remix with @UiReact project ${txtColors.reset} 👻`);
console.log('\n');
console.log(`${txtColors.blue}Project configs: ${txtColors.reset}`);
console.log('\n');
...
try {
  execSync('git clone https://github.com/inavac182/remix-w-uireact.git');
} catch (e) {
...
try {
  fs.rmSync('./remix-w-uireact/.git/', {recursive: true});
  fs.cpSync('./remix-w-uireact/', './', {recursive: true});
  fs.rmSync('./remix-w-uireact/', {recursive: true});
} catch (e) {
...
console.log(`${txtColors.blue} http://localhost:5173`);
console.log('\n');
