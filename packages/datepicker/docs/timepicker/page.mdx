...
> A timepicker that lets the user select a time of the day based on a 24 hours format.

## Installation

> npm i -S @uireact/flex @uireact/button @uireact/grid @uireact/menu @uireact/text @uireact/datepicker
