...
<Metadata packageName='card' packageJson={packageJson} description='Component to render content, it has built in styling and props to make it flexible. It also extends motion.div so you can pass through any prop for motion animations.' includeInformation />
