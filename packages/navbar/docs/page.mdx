...
<Metadata packageName='navbar' packageJson={packageJson} description='Creates a navbar container and provides components to provide styling and coloration based on the theme' includeInformation />
