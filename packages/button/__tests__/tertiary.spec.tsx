...
describe('<UiTertiaryButton />', () => {
  ...
  test('renders button', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('button transparent hover-bg-primary-100 color-secondary-100 active-bg-primary-150 padding-top-three padding-bottom-three padding-left-four padding-right-four buttonRadius');
  });
  ...
  test('renders disabled', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('button transparent bg-primary-100 color-secondary-50 padding-top-three padding-bottom-three padding-left-four padding-right-four buttonRadius');
  });
  ...
  test('renders disabled icon', () => {
    ...
    expect(screen.getByTestId('my-button')).toBeDisabled();
    expect(screen.getByRole('button')).toHaveClass('button transparent bg-primary-100 color-secondary-50 padding-top-three padding-bottom-three padding-left-four padding-right-four buttonIcon');
  }); 
  ...
  test('renders rounded', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('button transparent hover-bg-primary-100 color-secondary-100 active-bg-primary-150 padding-top-three padding-bottom-three padding-left-four padding-right-four radius-regular');
  }); 
  ...
  test('renders full width', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('button transparent hover-bg-primary-100 color-secondary-100 active-bg-primary-150 buttonFullWidth padding-top-three padding-bottom-three padding-left-four padding-right-four buttonRadius');
  });
  ...
  test('renders full height', () => {
    ...
    expect(screen.getByRole('button')).toBeVisible();
    expect(screen.getByRole('button')).toHaveClass('button transparent hover-bg-primary-100 color-secondary-100 active-bg-primary-150 buttonFullHeight padding-top-three padding-bottom-three padding-left-four padding-right-four buttonRadius');
  });
  ...
  test('renders button with margin', () => {
    ...
    expect(screen.getByRole('button', { name: 'Button' })).toBeVisible();
    expect(screen.getByRole('button')).toHaveClass('button transparent hover-bg-primary-100 color-secondary-100 active-bg-primary-150 padding-top-three padding-bottom-three padding-left-four padding-right-four margin-two buttonRadius');
  });
});
