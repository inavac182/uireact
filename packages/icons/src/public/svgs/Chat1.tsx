...
const SvgChat1 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M338.783 160h-200c-7.5 0-13.5 6-13.5 13.5s6 13.5 13.5 13.5h200c7.5 0 13.5-6 13.5-13.5s-6.1-13.5-13.5-13.5zM338.783 225.3h-200c-7.5 0-13.5 6-13.5 13.5s6 13.5 13.5 13.5h200c7.5 0 13.5-6 13.5-13.5s-6.1-13.5-13.5-13.5zM338.783 290.6h-200c-7.5 0-13.5 6-13.5 13.5s6 13.5 13.5 13.5h200c7.5 0 13.5-6 13.5-13.5s-6.1-13.5-13.5-13.5z" />
  </svg>
);
