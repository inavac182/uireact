...
import { UiReactSvgDraw } from '@uireact/framer-animations';
...
```jsx live scope={{UiIcon, UiReactSvgDraw}}
  <UiIcon icon="Search" size="xlarge" category="tertiary" motionPath={UiReactSvgDraw} />
```
