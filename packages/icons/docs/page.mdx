...
```
## UiIcon with animation

```jsx live scope={{UiIcon, UiReactViewPulse}}
  <UiIcon icon="Search" size="xlarge" category="tertiary" motionSvg={{...UiReactViewPulse, animate: { scale: 2 } }} />
```
