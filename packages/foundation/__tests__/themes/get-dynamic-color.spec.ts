...
describe('getDynamicColor', () => {
  test('Should get the correct text colors from dark theme when SUCCESS and NORMAL dynamic element is needed', () => {
    let value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.paragraph, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, Themes.dark);
    expect(value).toBe(Themes.dark.colors.dynamicElements.success.normal.paragraph);

    value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.heading, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, Themes.dark);
  ...
  test('Should get the correct text colors from light theme when SUCCESS and NORMAL dynamic element is needed', () => {
    let value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.paragraph, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, Themes.light);
    expect(value).toBe(Themes.light.colors.dynamicElements.success.normal.paragraph);

    value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.heading, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, Themes.light);
  ...
  test('Should get the correct text colors from a custom theme when SUCCESS and NORMAL dynamic element is needed', () => {
    ...
    let value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.paragraph, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, customTheme);
    expect(value).toBe('custom-color-paragraph');

    customTheme.colors.dynamicElements.success.normal.paragraph = 'custom-color-heading';
    value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.paragraph, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, customTheme);
  ...
  test('Should log warn when color is not found in action dynamic element', () => {
    ...
    const value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.paragraph, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, customTheme);
  ...
  test('Should log error when theme is undefined', () => {
    ...
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    //@ts-ignore
    const value = getDynamicColor(CategoryTheme.DYNAMIC_ELEMENTS, StaticElementEnum.paragraph, DynamicElementStateEnum.SUCCESS, DynamicElementActionEnum.NORMAL, undefined);
