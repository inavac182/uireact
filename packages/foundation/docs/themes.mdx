...
our structure provides with a lot of customization and flexibility keeping a standard and streamline designe system for a good UX.
...
We support for up to seven levels of spacing, for most use cases this should be enough as it can be combined using our [UiSpacing](https://uireact.io/packages-foundation-docs-spacing) component.
The values in this properties are used straight as a string into the CSS property for margins / paddings.
