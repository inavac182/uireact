...
# Framer animations
<Metadata packageName='framer-animations' packageJson={packageJson} description='Set of basic framer motion props that have animations configured to quickly re use animation objects through multiple components.' includeInformation />
