...
# UiDialog
<Metadata packageName='dialog' packageJson={packageJson} />
...
```jsx live scope={{DialogsExample, UiDialogType}}
  <DialogsExample type={UiDialogType.FULLSCREEN} dialogId="fullscreen-example" />
```
...
```jsx live scope={{DialogsExample, UiDialogType}}
  <DialogsExample type={UiDialogType.BOTTOM} dialogId="bottom-example" />
```
...
```jsx live scope={{DialogsExample, UiDialogType}}
  <DialogsExample type={UiDialogType.LEFT} dialogId="left-example" />
```
...
```jsx live scope={{DialogsExample, UiDialogType}}
  <DialogsExample type={UiDialogType.RIGHT} dialogId="right-example" />
```
