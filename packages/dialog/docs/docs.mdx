...
The [<DialogsExample />](https://github.com/inavac182/uireact/blob/main/packages/dialog/docs/utils/DialogsExample.tsx#L15) that has been used throughout these docs for the dialogs examples looks like this:
