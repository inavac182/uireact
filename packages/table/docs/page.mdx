...
<Metadata packageName='table' packageJson={packageJson} description='Used to render information in a table that is filterable and sortable.' includeInformation />
